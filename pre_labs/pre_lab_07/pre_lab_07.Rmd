...
```{r echo=FALSE}
census_api_key("5e8e056c12198d70aecaae8e5de29193f6e42b51", install=TRUE)
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer** Nevada had the largest percentage change of all the states listed. 
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer** Howard County has the highest median household income with roughly $129,000.
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** The headline should be "Margin of Errors for household income by county in Maryland" or something like that where it notes that the margin of error is being examined.
...
Is the difference between Calvert and Montgomery significant? **Answer** No, they aren't statistically significant since Montgomery County overlaps with the beginning portion of Calvert County's margin of error.

Is the difference between Howard and everyone else significant? **Answer** Yes it is since it doesn't overlap with any of the other counties listed. 
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** About 50 high school's who's median income is around 111,000 have about 60% of their students enrolled in college. On the other hand, there are about 76 schools who have 40% or less of their students enrolled in college with a median income of about 69,000. 
...
**Task** What is another question you could ask of this data? **Answer** We could look on a more detailed level by looking at which high school in the state has the most college enrollment and what the maximum income looks like in that area. 
