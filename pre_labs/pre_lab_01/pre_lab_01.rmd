...
In the space below, write the title of the cuorse from the first row of the "name" column. **Answer** Directed Research, Intro Linguistics, Independent Study, Directed Studies in Linguistics, Doctoral Dissertation Research, Directed Study
...
**Answer** The code is organizing the number of courses that is being offered for each semester/term from fall, spring, winter, and summer.
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** It organized the data with which term offers the most classes from greatest to least. "arrange(desc(count_classes))" makes this shift in organization.
...
**Answer** Added another column, term and department. It's going from the oldest term to the most recent term
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** This is counting the number of classes for each term and its total seats. It lists the class with the most seats available first then goes in descending order.
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** The code has added more columns and it calculated the mean and median of seats for each course. Although more calculations appear, they are still in the same descending order it's just more information is available. 
...
**Answer** Instead of the results being sorted by term they are sorted by which department offers the most classes and the total number of seats and it calculates the mean and median of all. Similar to the previous code its still in descending order. 
...
1.  What percent of undergraduate students are Business majors?

2.  Why was there an influx of courses offered in Fall 2022? Was the university still trying to recover from the Pandemic?

3. From Fall 2022 to Fall 2023, there was a decrease in 150 courses, which department seen the most cuts in this time frame?
