...
**Task** Run the following code and describe the dataframe it outputs. **Answer** It gives us a dataframe that has 999 entries. Inside is the date, title, url and text of all press releases from Sen. Ben Cardin. 
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** It groups the difference cased words together. We should want all words to be the same so that we can fully analyze it 
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** It pulled a part all the words and created a list of tokens in a data frame to see which ones come up the most.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** Yes, it's interesting since "the" is a common word. Also, it's kind of boring since these aren't "unique words."
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** Yes, it's more interesting since these aren't just articles. Health is ranked high while government is at the bottom. Also, it gives us an insight into the things that he cares about. 
...
**Task** Run the following code and describe the results. **Answer** It gives us the most popular words he's used in his releases from 2021-2023. It kind of shows how the things that are happening the world alter the things that he speaks about. Past 2021 he doesn't speak about covid anymore, but in 2023 he starts talking about fire, women and rights. 
...
**Task** Run the following code and describe the results. **Answer** This gives us two word names that are typically associated together. This list seems more detailed too and not just one word hits. 
...
**Task** Run the following code and describe the results. **Answer** Project location is the top word for 2022 with amount included right after. It seems money and locations were his top priority this year. But he still continued to speak aboout health care and covid 19. Prince George's was also a new word that didn't show up in 2021. 
...
**Task** Run the following code and describe the results. **Answer** Now, he's speaking more about health and rights. Oral health is a weird word that comes into play. It doesn't relate to anything he used to speak about before. Also offshore wind is another word that comes up that didn't appear in any other year. The chesapeake bay is still in the top 10 over these three years. 
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** The word "issue" is listed as negative, but I'm not sure if it's always seen that way. Issue could be negative or positive but it depends on the text of the information being used in connection with that word.
