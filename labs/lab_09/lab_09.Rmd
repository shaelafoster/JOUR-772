...
I think the story revolves around election day voting and mail in voting switching over this four year span. I think once the pandemic occurred, mail in votes increased. But we can see that early voting stayed almost consistent over these three years.
...
write_csv(montgomery_overdose_count, "data/montgomery_overdose_count.csv")
```
