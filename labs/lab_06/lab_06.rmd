...
Where are those zip codes in the city? - They are all in Baltimore city, The 21217 ranks the highest with 774 calls with a population of 37,111. 
...
A3. The zip codes include, 21201, 21202, 21205, 21213, 21216, 21217, and 21223. 21217 ranks the highest with 774 calls with a population of 37,111.  

```{r}
maryland_with_baltimore_city |>
  mutate(calls_per_1000 = (count_calls/1000)) |>
