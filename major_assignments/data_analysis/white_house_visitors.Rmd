...
We found out there are inconsistencies within the headers, so we're ensuring they all match. Before this, we cleaned the column names making them all lower case. 
```{r}
