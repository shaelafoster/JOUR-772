...
(8) Combine over_18 population data with the information to see the counties with a low population of over 18 population and see if there is any correlation with violent crime and the low rate of over 18 population. 
```{r}
